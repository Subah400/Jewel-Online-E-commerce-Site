...
<form method="POST">
    <div class="input-group rounded">
        <select class="form-control rounded" name="searchCat" aria-label="Search" aria-describedby="search-addon">
            <option value="" disabled selected>Select a category</option>
            <option value="Bag">Bags</option>
            <option value="Dress">Dresses</option>
            <option value="Bracelet">Bracelets</option>
            <!-- Add more categories as in this section similar to the ones above -->
        </select>
...
<section id="featured" class="my-5 pb-5">
    <div class="container text-center mt-5 py-5">
        ...
        <hr class="mx-auto">
        <p>Here You Can Check Out Categorical Products</p>
    </div>
    ...
    <div class="row mx-auto container-fluid">
        ...
        if (isset($_POST['search'])) {
            ...
            $result = searchCategory($searchcat);
